import { freePlan, GrowPlan, scalePlan } from "@/app/configs/contants";
        ...
        <div className="w-full md:flex items-start justify-around py-8">
            ...
            <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
                ...
                <div className="border-b pb-8 border-[#000]">
                    <h5 className="font-classDisplay uppercase text-cyber-ink text-3xl">
                        $0
                    </h5>
                ...
                <br />
                <button type="button" className="w-full  !py-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                    Get Started
                </button>

                <p className="pt-1 opacity-[.7] text-center">
                    30-days free trial of Scale features, then forever
                </p>
            </div>
            ...
            <svg
                ...
                <h5 className="font-clashDisplay uppercase text-cyber-link text-3xl pb-8 border">
                    GROW 
                </h5>
                <br/>
                ...
                <p className="pt-1 opacity-[.7] text-center">
                    30-days free trial of Scale features, then $
                    {active === "Monthly" ? "42" : "49"} / month
             </p>
            </div>
